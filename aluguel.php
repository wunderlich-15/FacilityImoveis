...
<body>
    ...
    <h1>Aluguel</h1>
        <?php
            $query_anuncio = "SELECT id_anuncio, titulo_anuncio, valor_anuncio, criacao_anuncio, descricao_anuncio, cidade_anuncio FROM anuncio WHERE tipo_anuncio = 'aluguel' ORDER BY id_anuncio DESC";
